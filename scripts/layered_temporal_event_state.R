# layered_temporal_event_state.R
...
plot_out <- viz_results_file("layered_temporal_event_state.png")
ggsave(plot_out, p,
...
graph_out <- viz_tidy_file("layered_temporal_event_state.rds")
saveRDS(g, graph_out)
cat("Graph saved to ", graph_out, "\n", sep = "")
