# augmented_bipartite_event_state.R
...
graph_out <- viz_tidy_file("augmented_bipartite_event_state.rds")
saveRDS(g, graph_out)
...
plot_out <- viz_results_file("augmented_bipartite_event_state.png")
ggsave(plot_out, p,
